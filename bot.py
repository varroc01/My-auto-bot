...
# ============================
# OTP POLLING - PEHLE JESA
# ============================
def poll_otp_updates():
    """Poll OTP updates - Forward OTP when changed"""
    while True:
        try:
...
def main():
    ...
    manual_sim_conv = ConversationHandler(
        ...
        states={
            WAITING_MANUAL_SIM: [CallbackQueryHandler(slot_selection_callback, pattern="^slot_")],
            WAITING_OTP_NUMBER: [MessageHandler(filters.TEXT & ~filters.COMMAND, manual_sim_number_input)]
        },
